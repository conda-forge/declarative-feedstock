...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/declarative-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13945&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/declarative-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `declarative` can be installed with:

```
conda install declarative
```

It is possible to list all of the versions of `declarative` available on your platform with:
